      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2">
          {photos.length > 0 ? (
            ...
            <div className="flex aspect-video items-center justify-center rounded-md border border-dashed border-slate-300 text-slate-400">
              No photos provided
            </div>
          )}
        ...
        <div>
          ...
          {listing.originalPrice > listing.askingPrice && (
            <p className="text-sm text-slate-400 line-through">{formatMoney(listing.originalPrice)}</p>
          )}
          ...
          <div className="mt-4">
            {isOwner ? (
              ...
              <p className="text-sm text-slate-500">This listing is no longer available.</p>
            ) : (
              <OfferBox
