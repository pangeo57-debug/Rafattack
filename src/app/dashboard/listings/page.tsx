  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-6 space-y-3">
        {listings.length === 0 && <p className="text-slate-500">You haven&apos;t listed anything yet.</p>}
        {listings.map((l) => (
          <div key={l.id} className={`${ui.card} flex flex-wrap items-center justify-between gap-3 p-4`}>
            <div>
