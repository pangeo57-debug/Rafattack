...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 text-sm leading-6 text-zinc-700 sm:px-6">
      ...
      <h2 className="mt-8 text-lg font-semibold text-zinc-900">2. Eligibility &amp; accounts</h2>
      ...
      <h2 className="mt-8 text-lg font-semibold text-zinc-900">3. Listings</h2>
      <ul className="mt-2 list-disc space-y-1 pl-5">
      ...
      <h2 className="mt-8 text-lg font-semibold text-zinc-900">7. Suspension &amp; termination</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-zinc-900">8. Disclaimers &amp; limitation of liability</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-zinc-900">9. Changes</h2>
      <p className="mt-2">
        We may update these Terms from time to time. Continued use of the
        Service after a change constitutes acceptance of the updated Terms.
      </p>

      <h2 className="mt-8 text-lg font-semibold text-zinc-900">10. Governing law</h2>
      <p className="mt-2">[GOVERNING LAW / JURISDICTION].</p>

      <h2 className="mt-8 text-lg font-semibold text-zinc-900">11. Contact</h2>
      <p className="mt-2">
