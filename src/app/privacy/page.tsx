...
export default function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 text-sm leading-6 text-slate-700 sm:px-6">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">1. Who this applies to</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">2. Information we collect</h2>
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">3. How we use this information</h2>
      <ul className="mt-2 list-disc space-y-1 pl-5">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">4. Who we share it with</h2>
      <ul className="mt-2 list-disc space-y-1 pl-5">
        <li>
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">5. Data retention</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">7. Deleting your account</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">8. Children</h2>
      <p className="mt-2">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">9. Changes to this policy</h2>
      <p className="mt-2">
        We may update this policy from time to time. Material changes will
        be posted on this page with an updated &ldquo;Last updated&rdquo; date.
      </p>

      <h2 className="mt-8 text-lg font-semibold text-slate-900">10. Contact</h2>
      <p className="mt-2">
